...
- 1. 下载依赖
  ...
  npm install --save-dev less less-loader node-sass sass sass-loader
  ```
...
- 1. 下载依赖
  ```
  npm i babel-eslint eslint eslint-config-airbnb eslint-friendly-formatter eslint-loader eslint-plugin-import eslint-plugin-jsx-a11y eslint-plugin-react eslint-plugin-react-hooks -D
  ```
